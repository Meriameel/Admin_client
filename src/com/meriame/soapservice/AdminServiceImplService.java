 ...
 * 
 */
@WebServiceClient(name = "AdminServiceImplService", targetNamespace = "http://soapService.meriame.com/", wsdlLocation = "http://localhost:8055/services/AdminService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICEIMPLSERVICE_QNAME = new QName("http://soapService.meriame.com/", "AdminServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8055/services/AdminService?wsdl");
    ...
    public Admin getAdminServiceImplPort() {
        return super.getPort(new QName("http://soapService.meriame.com/", "AdminServiceImplPort"), Admin.class);
    }
     ...
     */
    @WebEndpoint(name = "AdminServiceImplPort")
    public Admin getAdminServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapService.meriame.com/", "AdminServiceImplPort"), Admin.class, features);
    }
